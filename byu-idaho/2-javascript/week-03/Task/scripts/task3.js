...
const subtractNumbers = function() {
    let subtract1 = parseInt(document.getElementById('minuend').value);
    let subtract2 = parseInt(document.getElementById('subtrahend').value);
    let subtraction = subtract(subtract1, subtract2);
...
const mulitplyNumbers = () => {
    let multiple1 = parseInt(document.getElementById('factor1').value);
    let multiple2 = parseInt(document.getElementById('factor2').value);
    let multiplication = multiply(multiple1, multiple2);
...
const divideNumbers = () => {
    ...
    let division = divide(dividend, divisor);
...
document.querySelector('#sumOfArray').textContent = numbers.reduce((number1, number2) => number1 + number2, 0);
...
document.querySelector('#sumOfMultiplied').textContent = numbers.map(number => number * 2).reduce((number1, number2) => number1 + number2, 0);
