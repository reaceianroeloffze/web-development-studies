...
if (dayOfWeek >= 1 && dayOfWeek <= 5) {
    newMessage = 'Hang in there!';
}

// Step 6: Using an else statement, set the message variable to 'Woohoo!  It is the weekend!'
else {
    newMessage = "Woohoo! It's the weekend!";
}
...
switch ( dayOfWeek) {
    ...
    case 2:
        ...
        break;
    case 3:
        newMessage2 = 'Wednesday'
        break;
    case 4:
        newMessage2 = 'Thursday'
        break;
    case 5:
        newMessage2 = 'Friday'
        break;
    case 6:
        newMessage2 = 'Saturday'
        break;
    default:
        newMessage2 = 'Saturday is my favourite day!'
        break;
}
...
document.querySelector('#message1').textContent = newMessage;

// Step 2: Assign the value of the second message variable to the HTML element with an ID of message2
document.getElementById('message2').textContent = newMessage2;
...
const output = (temples) => {
    temples.forEach((temple) => {
      ...
      let dedicatedTemples = document.createElement("h4");
      dedicatedTemples.textContent = temple.dedicatedTemples;
      ...
      article.appendChild(dedicatedTemples);
